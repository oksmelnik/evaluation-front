        ...
        return ([
            ...
            dialog ?
                React.createElement(Dialog, { open: calendarShow, onClose: this.closeCalendar },
                    React.createElement(Calendar, { ref: function (calendar) { return _this.calendar = ReactDOM.findDOMNode(calendar); }, value: value, onChange: onChange, min: min, max: max, dialog: true })) :
                React.createElement(Popover, { open: calendarShow, anchorOrigin: placement || { vertical: 'top', horizontal: 'left' }, anchorEl: this.input },
                    React.createElement(Calendar, { ref: function (calendar) { return _this.calendar = ReactDOM.findDOMNode(calendar); }, value: value, onChange: onChange, min: min, max: max }))
        ]);
    };
